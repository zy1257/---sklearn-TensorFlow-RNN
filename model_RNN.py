...
class RNN_Model():
    def __init__(self, train_dir,test_dir,val_dir,vocab):
    ...
    def build_graph(self):
        ...
        embedding = tf.get_variable('embedding', [len(self.vocab), self.embedding_dim])
        ...
        fc = tf.layers.dense(last, 128, name='fc1')
...
with open('.\\train_vocab.pkl','rb') as f:
    vocab = pickle.load(f)
model = RNN_Model(train_dir,test_dir,val_dir,vocab)
model.build_graph()
##model.train()
model.test()
